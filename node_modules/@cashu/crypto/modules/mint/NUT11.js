...
exports.verifyP2PKSigOutput = exports.verifyP2PKSig = void 0;
...
const verifyP2PKSigOutput = (output, publicKey) => {
    if (!output.witness) {
        throw new Error('could not verify signature, no witness provided');
    }
    return secp256k1_1.schnorr.verify(output.witness.signatures[0], (0, sha256_1.sha256)(output.B_.toHex(true)), publicKey);
};
exports.verifyP2PKSigOutput = verifyP2PKSigOutput;
